...
function [pts] = poissonDisc(sizeI,spacing,nPts,showIter,lowfreq)
% Purpose:
...
k = 50;  % Number of 'dart' tries in each grid.
dartFactor = 100; %Select number of sample data in each iterations. Change it to
